        ...
        <Container className="form-section">
          <Row className="Row-contain pb-5">
            ...
            <Col sm={12} md={12} lg={6} className="col-flex">
              ...
              <Form>
                <Form.Group controlId="formBasicEmail">
                  <div className="mail-col"><a href="tel:+359879222333" style={{color: "#2780e3"}}>+359 879 222 333</a></div>
                </Form.Group>

                <Form.Group controlId="formBasicPassword">
                  <div className="mail-col"><a href="mailto:office4humandesign@gmail.com" style={{color: "#2780e3"}}>office4humandesign@gmail.com</a></div>
                </Form.Group>
